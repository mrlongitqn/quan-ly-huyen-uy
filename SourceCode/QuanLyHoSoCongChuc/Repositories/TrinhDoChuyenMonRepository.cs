...
namespace QuanLyHoSoCongChuc.Repositories
{
	...
	public class TrinhDoChuyenMonRepository
	{
		...
		public bool Delete(string matrinhdochuyenmon)
		{
			try
			{
		...
		public List<TrinhDoChuyenMon> RetrieveByID(string matrinhdochuyenmon)
		{
